...
def main():
    ...
    if parser.parse_args().scenario == "momentum_driver":
        from strategies.momentum_driver import momentum_driver_flow

        momentum_driver_flow()
    elif parser.parse_args().scenario == "sector_momentum":
        from strategies.sector_momentum import sector_momentum_flow

        sector_momentum_flow()
    elif parser.parse_args().scenario == "individual_stocks":
        from strategies.individual_stocks import individual_stocks_flow
