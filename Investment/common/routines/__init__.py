...
from ..data_retreival import get_stock_data
from ..calculations import calculate_atr, \
    calculate_pivot_points, determine_take_profit, calculate_risk_reward_ratio, \
    get_entry_price, calculate_ema, determine_stop_loss
from ..plotting import plot_data_with_indicators
...
def prep_position(
    ...
    pivot_point, support_1, support_2, resistance_1, resistance_2 = calculate_pivot_points(data_to_calc)
    ...
    if plot:
        plot_data_with_indicators(data, pivot_point, support_1, support_2,
                                  resistance_1, resistance_2, stop_loss,
                                  take_profit, f"{ticker} {investment_type} Trade")
